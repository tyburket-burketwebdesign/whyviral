...
check('#signup opens sign-in too', $('#screen-auth').classList.contains('active'));
check('#signup uses create-account wording', /create your account/i.test($('#auth-title').textContent), $('#auth-title').textContent);
